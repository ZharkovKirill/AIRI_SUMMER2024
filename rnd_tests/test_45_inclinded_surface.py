...
def controller(model, data):
    ...
    v = np.linalg.norm(data.qvel[0:3])#params.tire.size[0]/2 * (dtheta_l + dtheta_r)
    ...
    # if keyboard.is_pressed('p'):
    #     des_pos_l = np.array([0, -0.648185424949238+0.0825 + del_pos_r + 0.2])
    #     des_pos_r = np.array([0, -0.648185424949238+0.0825 + del_pos_l + 0.2])
    # elif keyboard.is_pressed('o'):
    #     des_pos_l = np.array([0, -0.648185424949238+0.0825 + del_pos_l])
    #     des_pos_r = np.array([0, -0.648185424949238+0.0825 + del_pos_r])
    # elif keyboard.is_pressed('i'):
...
plt.savefig("footages/test_45_ramp.svg")
