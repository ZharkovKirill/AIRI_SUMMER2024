...
env = sim.EnvironmentPendulum("models/robot.xml", "models/scene_pendulum.xml")
...
def controller(model, data):
    ...
    try:
        ...
        env.data.ctrl[0:6] = robot_context.get_control_vector(left_conf, left_wheel, right_conf, right_wheel)
